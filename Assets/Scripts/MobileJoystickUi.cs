...
public class MobileJoystickUi : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var tmpObj = new GameObject("Canvas");
        ...
        var canvasScaled = tmpObj.AddComponent<CanvasScaler>();
        ...
        var cntrlTmpObj = new GameObject("Movement Circle");
        ...
        var rectTransform = moveTouch.backgroundCircle.rectTransform;
        rectTransform.anchorMin = new Vector2(0, 0);
        rectTransform.anchorMax = new Vector2(0, 0);
        rectTransform.sizeDelta = new Vector2(circleSize, circleSize);
        rectTransform.pivot = new Vector2(0, 0);
        rectTransform.position = new Vector3(marginLeft, marginBottom, 0);
        ...
        var rectTransform1 = moveTouch.mainButton.rectTransform;
        rectTransform1.anchorMin = new Vector2(0, 0);
        rectTransform1.anchorMax = new Vector2(0, 0);
        rectTransform1.sizeDelta = new Vector2(buttonSize, buttonSize);
    ...
    {
        //Move controller
        if (!moveTouch.defaultArea.Contains(new Vector2(touchPos.x, Screen.height - touchPos.y)) ||
            moveTouch.isActive) return;
    ...
    {
        if (!moveTouch.isActive || moveTouch.touchID != touchId) return;
